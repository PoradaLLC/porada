      ...
      <div className="wrap">
        ...
        <div className="footer-grid footer-grid-3">
          <div>
            ...
            <a
              href="tel:+12019695875"
              style={{ display: "block", color: "var(--ink-soft)", fontSize: 14, marginTop: 6 }}
            >
              (201) 969-5875
            </a>
            <LocalClock />
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 14, marginTop: 20, color: "var(--ink-soft)" }}>
              <a
                href="https://www.facebook.com/profile.php?id=61589297094692"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Porada on Facebook"
                style={{ color: "inherit" }}
              >
                <IconFacebook />
              </a>
              <a
                href="https://www.instagram.com/poradasolutions/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Porada on Instagram"
                style={{ color: "inherit" }}
              >
                <IconInstagram />
              </a>
